...
各命令作用与前置条件见 [插件 README §2 命令表](./plugins/speccode/README.md)。
...
完整拓扑与要点见 [插件 README §3](./plugins/speccode/README.md)。
...
| 文档 | 内容 |
|---|---|
| [插件 README](./plugins/speccode/README.md) | 21 命令详表、三层拓扑、R1-R13 风险、0.1→0.2 迁移(插件设计文档) |
