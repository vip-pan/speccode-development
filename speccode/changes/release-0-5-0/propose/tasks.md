...
- [ ] 2. `plugins/speccode/.claude-plugin/plugin.json`:version `0.4.0` → `0.5.0`,与 CHANGELOG 同一提交:`git add CHANGELOG.md plugins/speccode/.claude-plugin/plugin.json && git commit -m "chore: release 0.5.0"`
- [ ] 3. 全量测试:`node --test ./plugins/speccode/tests/*.test.mjs` 全绿(基线 279)
