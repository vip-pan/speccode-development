...
- [ ] 1. 根 README.md:102 与 README_CN.md:102:「9 capabilities」/「9 个 capability」→ 11(双语同步,一处一行)
- [ ] 2. speccode/spec/git-workflow-lifecycle/spec.md「命令清单」requirement:枚举补 `distilling-knowledge`、`recording-knowledge`(archiving 之后、finishing-worktree 之前),「22 个」→「24 个」,scenario「上述全部 22 个命令」→ 24,并补归属说明一句(行为契约在 knowledge-set,此处仅登记)
